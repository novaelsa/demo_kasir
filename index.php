<?php
    ...
    if(isset($_POST['login'])){
        ...
        if($hasil > 0){
            ...
            $_SESSION['password'] = $_POST['password'];
            echo "<script>alert('Welcome')</script>";
            echo "<script>document.location.href ='admin/dashboardgudang.php'</script>";
        	}elseif($data['level']=="md"){
        	$_SESSION['username'] = $_POST['username'];
            $_SESSION['password'] = $_POST['password'];
            echo "<script>alert('Welcome')</script>";
            echo "<script>document.location.href ='admin/dashboardmk.php'</script>";
        	}
        }else{
